...
export type P2PMessageType = "direct" | "broadcast" | "agent-sync" | "instance-announce" | "user-message" | "delivery-ack";
...
export interface MeshNetwork {
    ...
    sendStructuredMessage(peerId: string, message: Omit<P2PMessage, "from" | "timestamp" | "instanceId" | "pubkey" | "signature"> & {
        timestamp?: number;
    }): Promise<void>;

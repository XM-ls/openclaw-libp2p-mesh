...
export type SetupPromptChoice = "continue" | "cancel" | "add-targets" | "sync-from-channels" | "disable-inbound" | "skip-inbound" | "network-entry-addresses" | "public-relay-node" | "inbound-targets" | "convert-legacy-inbound" | "keep-legacy-inbound" | "replace-legacy-inbound" | "add-target" | "edit-target" | "remove-target" | "finish-targets";

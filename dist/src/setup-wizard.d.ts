...
export type SetupPromptChoice = "continue" | "cancel" | "lan" | "cross-network" | "relay-node" | "add-targets" | "sync-from-channels" | "disable-inbound" | "skip-inbound" | "network-mode" | "inbound-targets" | "convert-legacy-inbound" | "keep-legacy-inbound" | "replace-legacy-inbound" | "add-target" | "edit-target" | "remove-target" | "finish-targets" | "preview-apply";
